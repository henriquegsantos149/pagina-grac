...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[var(--color-brand-dark)]">
      ...
      {/* Removed background animation remediation-pulse as requested */}
